  ...
  <div>
    <section id="about">
      ...
      <div class="top_skills">
        ...
        <div class="skill">
          <div class="icon-box">
            <v-icon class="icon" :size="50">{{ dynamic }}</v-icon>
          </div>
          <div>Dynamic</div>
          <div class="skill_details">
            Frontend and backend capabilities to produce an interactive user
            experience.
          </div>
        </div>
        <div class="skill">
      ...
      <div class="details">
        <div class="summary">
          ...
          <div class="personal-info">
            ...
            development in Atlanta, GA. I am passionate about creating
            intuitive, dynamic user experiences with an intense focus on
            developing clean, readable and maintainable code.
          </div>
        </div>
        <div class="technical">
          <div class="skill-bar">
...
export default {
  ...
  components: {},
  data: () => ({
    responsive: mdiCellphoneLink,
    dynamic: mdiRocketLaunch,
    intuitive: mdiLightbulb,
    fast: mdiSpeedometer
  })
};
</script>
